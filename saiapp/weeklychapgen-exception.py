...
#3. THIS CODE IS FOR EXCEPTION WHEN THE WEEK REQUIRED ONE CHAPTER TO BE READ.
...
#insquery = "Insert into testchapters (rollnumber,currentchapters,parayandate,house,Genstatus,gendate)"
i = 1
while i < 49:
    #print(i)
    if i == 1:
...
#cursor.execute("DELETE FROM `testchapters` WHERE 1")
for x in range(0,48):
    #print(querylist[x])
